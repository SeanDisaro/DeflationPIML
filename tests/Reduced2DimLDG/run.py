...
def run():
    ...
    model,featuresSolution = train( model= model, x = points, numSolutions = numSolutions, epochs= 1000, boundaryPoints= None,
            ...
            addRandomFeaturesToSolutions = False, alpha = alpha, beta = 0.1, gamma = gamma, delta = delta, FrequencyReportLosses = 20)
    ...
    gamma =gamma  * 10
    delta = delta * 10
    model,featuresSolution =train( model= model, x = points, numSolutions = numSolutions, epochs= 1000, solutionFeatures= featuresSolution, boundaryPoints= None,
            learningRate = learningRate,loadBestModel = False, verbose = True, showTrainingPlot = True, 
            addRandomFeaturesToSolutions = False, alpha = 0.1, beta = 0.1, gamma = 1., delta = 1., FrequencyReportLosses = 20)
